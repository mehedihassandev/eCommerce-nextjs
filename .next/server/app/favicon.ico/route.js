    ...
    (A.modules = {
      ...
      4994: (A, e, w) => {
        ...
        let a = 'force-static',
          s = new t.AppRouteRouteModule({
            ...
            resolvedPagePath:
              'next-metadata-route-loader?filePath=%2Fhome%2Fmh%2FDesktop%2Fpersonal%2Fnextjs-eCommerce%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__',
            nextConfigOutput: '',
            userland: i,
          }),
              ...
              226: function (t, o) {
                !(function (r, D) {
                  ...
                  var n = 'function',
                    ...
                    W = function (A, e) {
                      for (var w, i, t, o, r, P, s = 0; s < e.length && !r; ) {
                        var u = e[s],
                          c = e[s + 1];
                        for (w = i = 0; w < u.length && !r && u[w]; )
                          if ((r = u[w++].exec(A)))
                            for (t = 0; t < c.length; t++)
                              (P = r[++i]),
                                typeof (o = c[t]) === a && o.length > 0
                                  ? 2 === o.length
                                    ? typeof o[1] == n
                                      ? (this[o[0]] = o[1].call(this, P))
                                      : (this[o[0]] = o[1])
                                    : 3 === o.length
                                    ? typeof o[1] !== n ||
                                      (o[1].exec && o[1].test)
                                    ...
                                    : 4 === o.length &&
                                      (this[o[0]] = P
                                        ? o[3].call(this, P.replace(o[1], o[2]))
                                        : void 0)
                                  : (this[o] = P || D);
                        s += 2;
                      }
                    ...
                    AA = function (A, e) {
                      ...
                      var w = typeof r !== P && r.navigator ? r.navigator : D,
                      ...
                      return (
                        ...
                        (this.getEngine = function () {
                          var A = {};
                          return (
                            (A[l] = D), (A[d] = D), W.call(A, i, o.engine), A
                          );
                        }),
                        (this.getOS = function () {
                          var A = {};
                  ...
                  (AA.VERSION = '1.0.35'),
                    (AA.BROWSER = U([l, d, u])),
                    (AA.CPU = U([f])),
                    (AA.DEVICE = U([c, b, g, p, B, m, h, v, y])),
                    (AA.ENGINE = AA.OS = U([l, d])),
                    typeof o !== P
                      ...
                      : typeof r !== P && (r.UAParser = AA);
                  var Ae = typeof r !== P && (r.jQuery || r.Zepto);
                  if (Ae && !Ae.ua) {
                    var Aw = new AA();
                    (Ae.ua = Aw.getResult()),
                      (Ae.ua.get = function () {
      ...
      6050: (A, e, w) => {
        ...
        Object.defineProperty(e, '__esModule', { value: !0 }),
          Object.defineProperty(e, 'unstable_after', {
            enumerable: !0,
            get: function () {
              return t;
            },
      ...
      4899: (A, e, w) => {
        ...
        class s extends Response {
          constructor(A, e = {}) {
            super(A, e);
            let w = this.headers,
              P = new Proxy(new D.ResponseCookies(w), {
                get(A, t, o) {
                  switch (t) {
                    case 'delete':
                    case 'set':
          ...
          static redirect(A, e) {
            ...
            return (
              ...
              new s(null, { ...i, headers: t, status: w })
            );
          }
          static rewrite(A, e) {
