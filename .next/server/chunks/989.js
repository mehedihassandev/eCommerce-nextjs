        ...
        return 'performance' in globalThis
          ? {
              ...
              loadChunk: (...t) => {
                ...
                try {
                  return (a += 1), e.__next_app__.loadChunk(...t);
                } finally {
                  n += performance.now() - r;
                }
              },
        ...
        return function (r, n) {
          ...
          if ('string' != typeof r || n) {
            ...
            (o = JSON.stringify([
              ...
              (a = t.url);
          } else (o = '["GET",[],null,"follow",null,null,null,null]'), (a = r);
          let s = t(a);
          if (0 === s.length) (i = e(r, n)), s.push(o, i);
          else {
            for (let e = 0, t = s.length; e < t; e += 2) {
              let t = s[e],
                r = s[e + 1];
              if (t === o) return (i = r).then((e) => e.clone());
            }
            (i = e(r, n)), s.push(o, i);
          }
          ...
          let T = (0, a.getTracer)().trace(
            ...
            async () => {
              ...
              let m = u && 'object' == typeof u && 'string' == typeof u.method,
                _ = (e) => (null == d ? void 0 : d[e]) || (m ? u[e] : null),
                y = (e) => {
                  var t, r, n;
                  return void 0 !==
              ...
              let N = R && 'unstable-cache' !== R.type ? R.implicitTags : [],
                C =
                  R && 'unstable-cache' === R.type
                    ? 'force-no-store'
                    : P.fetchCache,
                x = !!P.isUnstableNoStore,
                w = _('cache'),
                I = '';
              'string' == typeof w &&
                void 0 !== S &&
              ...
              let L = _('headers'),
                j =
                  'function' == typeof (null == L ? void 0 : L.get)
                    ? L
                    : new Headers(L || {}),
                k = j.get('authorization') || j.get('cookie'),
                G = !['get', 'head'].includes(
              ...
              switch (C) {
                ...
                case 'force-cache':
                  (void 0 === S || 0 === S) &&
                    ((I = 'fetchCache = force-cache'), (g = o.INFINITE_CACHE));
              }
              if (
                (void 0 === g
                  ? 'default-cache' !== C || x
                    ? 'default-no-store' === C
                      ? ((g = 0), (I = 'fetchCache = default-no-store'))
                      : x
                      ? ((g = 0), (I = 'noStore call'))
                      : B
                      ? ((g = 0), (I = 'auto no cache'))
                      : ((I = 'auto cache'),
                        (g = A ? A.revalidate : o.INFINITE_CACHE))
                    : ((g = o.INFINITE_CACHE),
                      (I = 'fetchCache = default-cache'))
                  : I || (I = `revalidate: ${g}`),
                !(P.forceStatic && 0 === g) && !B && A && g < A.revalidate)
              ) {
                if (0 === g) {
                ...
                A && S === g && (A.revalidate = g);
              }
              let H = 'number' == typeof g && g > 0,
                { incrementalCache: F } = P,
                V = void 0 !== R && 'request' === R.type ? R : void 0;
              if (F && (H || (null == V ? void 0 : V.serverComponentsHmrCache)))
                try {
                  n = await F.generateCacheKey(v, m ? u : d);
                } catch (e) {
                ...
                X = async (t, a) => {
                  ...
                  return e(u, s).then(async (e) => {
                    if (
                      ...
                      let t = g >= o.INFINITE_CACHE ? o.CACHE_ONE_YEAR : g,
                        r = !(g >= o.INFINITE_CACHE) && g;
                      if (!R || 'prerender' !== R.type)
                        return (
                          e
                            .clone()
              ...
              if (n && F) {
                ...
                if (
                  ((null == V ? void 0 : V.isHmrRefresh) &&
                    ...
                    ((e = V.serverComponentsHmrCache.get(n)), (W = !0)),
                  H && !e)
                ) {
                  q = await F.lock(n);
              ...
              if (!n || !K) return X(!1, a);
              {
                ...
                return o.catch(() => {}), (P.pendingRevalidates[e] = o), r;
              }
            },
          );
          if (O)
        ...
        trace(...e) {
          ...
          f
            ? (null == (t = u.getSpanContext(f)) ? void 0 : t.isRemote) &&
              (_ = !0)
            : ((f = (null == i ? void 0 : i.active()) ?? d), (_ = !0));
          let y = v();
          return (
            (l.attributes = {
              'next.span_name': p,
